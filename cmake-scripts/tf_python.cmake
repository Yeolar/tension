...
function(RELATIVE_PROTOBUF_GENERATE_PYTHON ROOT_DIR SRCS)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      ARGS --python_out  ${CMAKE_CURRENT_BINARY_DIR}/tf_python/ -I ${ROOT_DIR} -I ${protobuf_INCLUDE_DIR} ${ABS_FIL}
...
foreach(python_proto ${python_protos})
  if(NOT python_proto MATCHES "^\#")
    ...
    if(NOT EXISTS "${PROJECT_SOURCE_DIR}/${python_proto}")
      message(SEND_ERROR "Python proto directory not found: ${python_proto}")
    endif()
    file(GLOB_RECURSE tf_python_protos_src RELATIVE ${PROJECT_SOURCE_DIR}
        "${PROJECT_SOURCE_DIR}/${python_proto}/*.proto"
    )
...
RELATIVE_PROTOBUF_GENERATE_PYTHON(
    ${PROJECT_SOURCE_DIR} PYTHON_PROTO_GENFILES ${tf_python_protos_srcs}
)
...
foreach(python_proto_cc ${python_protos_cc})
  if(NOT python_proto_cc MATCHES "^\#")
    ...
    if(NOT EXISTS "${PROJECT_SOURCE_DIR}/${python_proto_cc}")
      message(SEND_ERROR "Python proto CC directory not found: ${python_proto_cc}")
    endif()
    file(GLOB_RECURSE tf_python_protos_cc_src RELATIVE ${PROJECT_SOURCE_DIR}
        "${PROJECT_SOURCE_DIR}/${python_proto_cc}/*.proto"
    )
...
RELATIVE_PROTOBUF_GENERATE_CPP(PROTO_SRCS PROTO_HDRS
    ${PROJECT_SOURCE_DIR} ${tf_python_protos_cc_srcs}
)
...
function(add_python_module MODULE_NAME)
    ...
    file(GLOB module_python_srcs RELATIVE ${PROJECT_SOURCE_DIR}
        "${PROJECT_SOURCE_DIR}/${MODULE_NAME}/*.py"
    )
    if(NOT ${ADD_PYTHON_MODULE_DONTCOPY})
        foreach(script ${module_python_srcs})
	        ...
	        add_custom_command(TARGET tf_python_copy_scripts_to_destination PRE_BUILD
                  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/${script} ${CMAKE_CURRENT_BINARY_DIR}/tf_python/${script})
            endif()
        endforeach()
    endif()
endfunction()
...
foreach(python_module ${python_modules})
  if(NOT python_module MATCHES "^\#")
    ...
    if(NOT EXISTS "${PROJECT_SOURCE_DIR}/${python_module}")
...
add_custom_command(TARGET tf_python_copy_scripts_to_destination PRE_BUILD
  COMMAND ${PYTHON_EXECUTABLE} ${PROJECT_SOURCE_DIR}/tensorflow/tools/build_info/gen_build_info.py --raw_generate ${BUILD_INFO_PY} ${tensorflow_BUILD_INFO_FLAGS})
...
set(tf_python_op_gen_main_srcs
    "${PROJECT_SOURCE_DIR}/tensorflow/python/eager/python_eager_op_gen.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/eager/python_eager_op_gen.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/python_op_gen.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/python_op_gen.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/python_op_gen_main.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/python_op_gen.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/python_op_gen_internal.h"
)
...
function(GENERATE_PYTHON_OP_LIB tf_python_op_lib_name)
    ...
    add_custom_command(
      ...
      COMMAND ${tf_python_op_lib_name}_gen_python ${PROJECT_SOURCE_DIR}/tensorflow/core/api_def/base_api,${PROJECT_SOURCE_DIR}/tensorflow/core/api_def/python_api ${require_shape_fn} > ${GENERATE_PYTHON_OP_LIB_DESTINATION}
...
add_custom_command(
      ...
      ARGS -python -c++
           ...
           -globals ''
           ${PROJECT_SOURCE_DIR}/tensorflow/python/tensorflow.i
...
set (pywrap_tensorflow_internal_src
    ...
    "${PROJECT_SOURCE_DIR}/tensorflow/python/eager/pywrap_tfe.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/eager/pywrap_tensor.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/eager/pywrap_tfe_src.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/client/tf_session_helper.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/client/tf_session_helper.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/eager/python_eager_op_gen.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/eager/python_eager_op_gen.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/cpp_shape_inference.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/cpp_shape_inference.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/python_op_gen.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/framework/python_op_gen.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/bfloat16.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/bfloat16.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/numpy.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/numpy.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/ndarray_tensor.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/ndarray_tensor.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/ndarray_tensor_bridge.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/ndarray_tensor_bridge.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/py_func.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/py_func.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/py_seq_tensor.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/py_seq_tensor.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/py_util.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/py_util.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/safe_ptr.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/core/safe_ptr.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/io/py_record_reader.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/io/py_record_reader.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/io/py_record_writer.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/lib/io/py_record_writer.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/util/kernel_registry.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/util/kernel_registry.cc"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/util/util.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/python/util/util.cc"
...
if(WIN32)
    ...
    set(tf_periodic_resample_srcs
       "${PROJECT_SOURCE_DIR}/tensorflow/contrib/periodic_resample/kernels/periodic_resample_op.cc"
       "${PROJECT_SOURCE_DIR}/tensorflow/contrib/periodic_resample/kernels/periodic_resample_op.h"
    ...
    set(tf_nearest_neighbor_srcs
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/nearest_neighbor/kernels/heap.h"
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/nearest_neighbor/kernels/hyperplane_lsh_probes.h"
...
if(WIN32)
    ...
    set(tf_gru_srcs
        ...
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/rnn/kernels/blas_gemm.h"
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/rnn/kernels/gru_ops.cc"
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/rnn/kernels/gru_ops.h"
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/rnn/ops/gru_ops.cc"
    )
    set(tf_gru_gpu_srcs
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/rnn/kernels/gru_ops_gpu.cu.cc"
    )
    ...
    set(tf_lstm_srcs
        ...
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/rnn/kernels/lstm_ops.h"
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/rnn/ops/lstm_ops.cc"
    )
    set(tf_lstm_gpu_srcs
        "${PROJECT_SOURCE_DIR}/tensorflow/contrib/rnn/kernels/lstm_ops_gpu.cu.cc"
    )
...
set(tf_beam_search_srcs
    ...
    "${PROJECT_SOURCE_DIR}/tensorflow/contrib/seq2seq/kernels/beam_search_ops.h"
    "${PROJECT_SOURCE_DIR}/tensorflow/contrib/seq2seq/ops/beam_search_ops.cc"
)

set(tf_beam_search_gpu_srcs
    "${PROJECT_SOURCE_DIR}/tensorflow/contrib/seq2seq/kernels/beam_search_ops_gpu.cu.cc"
)
...
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/tensorflow/tools/pip_package/setup.py
...
add_custom_command(TARGET tf_python_copy_scripts_to_destination PRE_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/tensorflow/contrib/testing/python/framework/util_test.py
...
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/tensorflow/tools/pip_package/README
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/)
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/tensorflow/tools/pip_package/MANIFEST.in
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/)

# Copy datasets for tf.contrib.learn.
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/tensorflow/contrib/learn/python/learn/datasets/data/boston_house_prices.csv
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/contrib/learn/python/learn/datasets/data/)
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/tensorflow/contrib/learn/python/learn/datasets/data/iris.csv
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/contrib/learn/python/learn/datasets/data/)
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/tensorflow/contrib/learn/python/learn/datasets/data/text_test.csv
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/contrib/learn/python/learn/datasets/data/)
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_SOURCE_DIR}/tensorflow/contrib/learn/python/learn/datasets/data/text_train.csv
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/contrib/learn/python/learn/datasets/data/)
...
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${PROJECT_SOURCE_DIR}/tensorflow/core
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/include/tensorflow/core)
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_CURRENT_BINARY_DIR}/tensorflow/core
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/include/tensorflow/core)
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${PROJECT_SOURCE_DIR}/tensorflow/stream_executor
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/include/tensorflow/stream_executor)
...
add_custom_command(TARGET tf_python_build_pip_package POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${PROJECT_SOURCE_DIR}/third_party/eigen3
                                   ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/include/third_party/eigen3)
