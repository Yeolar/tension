...
if(WIN32)
  file(GLOB_RECURSE tf_core_kernels_windows_exclude_srcs
      ...
      "${PROJECT_SOURCE_DIR}/tensorflow/core/kernels/neon/*"
...
if(WIN32 AND tensorflow_ENABLE_GPU)
  file(GLOB_RECURSE tf_core_kernels_cpu_only_srcs
      ...
      "${PROJECT_SOURCE_DIR}/tensorflow/core/kernels/matrix_diag_op.cc"
      "${PROJECT_SOURCE_DIR}/tensorflow/core/kernels/one_hot_op.cc")
